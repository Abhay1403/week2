alpha = 1+mod(202,3);  %roll number 211EE202 Abhay Hubballi
...
% Plot the original signal and the amplitude spectrum
subplot(2, 1, 1);
plot(t, signal);
...
% Optionally, you can set the x-axis limit for better visualization of the spectrum
xlim([0, Fs/2]);
